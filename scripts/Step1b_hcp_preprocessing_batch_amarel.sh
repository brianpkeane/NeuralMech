...
do
	...
	echo "${preproc_script} --server='amarel' --preFS='false' --FS='false' --postFS='false' --fmriVol='false' --fmriSurf='false' --restFix='false' --msmAll='false' --dedriftResample='true' --subj='${subjNum}'" >> $batchFilename # this is updated by bpk, 8/3/2018
