...
/home/keanebp/projects/NeuralMech/docs/scripts//Step1_hcp_preprocessing_msmall_amarel.sh --server='amarel' --preFS='false' --FS='false' --postFS='false' --fmriVol='false' --fmriSurf='false' --restFix='false' --msmAll='true' --dedriftResample='false' --subj='sub-S31'
