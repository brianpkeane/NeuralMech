...
/home/keanebp/projects/NeuralMech/docs/scripts//Step1_hcp_preprocessing_msmall_amarel.sh --server='amarel' --preFS='true' --FS='false' --postFS='false' --fmriVol='false' --fmriSurf='false' --restFix='false' --msmAll='false' --dedriftResample='false' --subj='sub-S31'
